  ...
  return (
    <>
      ...
      <p>
        ...
        the route doesn&apos;t have one, it will bubble up to the routes above
      ...
      <p>
        ...
        This is great when loading data from a database isn&apos;t found. As
        soon as you know you can&apos;t render the component normally, throw a
        404 response and send your app into the catch boundary. Just like error
